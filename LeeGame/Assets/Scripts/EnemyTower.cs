...
//		frontCheck = transform.Find("frontCheck").transform;
		...
		healthBar = GameObject.Find("HealthBar_").GetComponent<SpriteRenderer>();
...
*/
	...
	void getClosestEnemy()
	{
		...
		foreach(GameObject taggedEnemy in taggedEnemys)
		{
			...
			dist = ( transform.position.x- objectPos.x);
...
//				animator.SetTrigger ("Run");
	...
	public void UpdateHealthBar ()
	{
		...
		healthBar.material.color = Color.Lerp(Color.red, Color.yellow, 1 - HP * 0.01f);
