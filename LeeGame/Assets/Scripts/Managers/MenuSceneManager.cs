...
public class MenuSceneManager : MonoBehaviour 
{
	...
	void Start () 
	{
		// we check what music we were playing and fade it out (we may go from Intro, Scores or Game scene, to Menu)
		...
		if (BaseManager.globalMenuMusic == null)
		{
			...
			BaseManager.globalMenuMusic = AudioHelper.CreateGetFadeAudioObject (BaseManager.instance.menuMusic, true, BaseManager.instance.fadeClip, "Audio-MenuMusic");
